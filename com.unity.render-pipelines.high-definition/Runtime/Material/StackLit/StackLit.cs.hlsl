...
#define DEBUGVIEW_STACKLIT_SURFACEDATA_CURVATURE (1135)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_THICKNESS (1136)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_SPECULAR_OCCLUSION_FROM_CUSTOM_INPUT (1137)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_SPECULAR_OCCLUSION_FIXUP_VISIBILITY_RATIO_THRESHOLD (1138)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_SPECULAR_OCCLUSION_FIXUP_STRENGTH (1139)
#define DEBUGVIEW_STACKLIT_SURFACEDATA_SPECULAR_OCCLUSION_FIXUP_MAX_ADDED_ROUGHNESS (1140)
...
#define DEBUGVIEW_STACKLIT_BSDFDATA_SHAPE_PARAM (1186)
#define DEBUGVIEW_STACKLIT_BSDFDATA_WORLD_SCALE (1187)
#define DEBUGVIEW_STACKLIT_BSDFDATA_FILTER_RADIUS (1188)
#define DEBUGVIEW_STACKLIT_BSDFDATA_CURVATURE (1189)
#define DEBUGVIEW_STACKLIT_BSDFDATA_THICKNESS (1190)
#define DEBUGVIEW_STACKLIT_BSDFDATA_USE_THICK_OBJECT_MODE (1191)
#define DEBUGVIEW_STACKLIT_BSDFDATA_TRANSMITTANCE (1192)
#define DEBUGVIEW_STACKLIT_BSDFDATA_SPECULAR_OCCLUSION_CUSTOM_INPUT (1193)
#define DEBUGVIEW_STACKLIT_BSDFDATA_SO_FIXUP_VISIBILITY_RATIO_THRESHOLD (1194)
#define DEBUGVIEW_STACKLIT_BSDFDATA_SO_FIXUP_STRENGTH_FACTOR (1195)
#define DEBUGVIEW_STACKLIT_BSDFDATA_SO_FIXUP_MAX_ADDED_ROUGHNESS (1196)
...
void GetGeneratedSurfaceDataDebug(uint paramId, SurfaceData surfacedata, inout float3 result, inout bool needLinearToSRGB)
{
    switch (paramId)
    {
        ...
        case DEBUGVIEW_STACKLIT_SURFACEDATA_SUBSURFACE_MASK:
            ...
            break;
        case DEBUGVIEW_STACKLIT_SURFACEDATA_CURVATURE:
...
void GetGeneratedBSDFDataDebug(uint paramId, BSDFData bsdfdata, inout float3 result, inout bool needLinearToSRGB)
{
    switch (paramId)
    {
        ...
        case DEBUGVIEW_STACKLIT_BSDFDATA_SUBSURFACE_MASK:
            ...
            break;
        case DEBUGVIEW_STACKLIT_BSDFDATA_SHAPE_PARAM:
            result = bsdfdata.shapeParam;
            break;
        case DEBUGVIEW_STACKLIT_BSDFDATA_WORLD_SCALE:
            result = bsdfdata.worldScale.xxx;
            break;
        case DEBUGVIEW_STACKLIT_BSDFDATA_FILTER_RADIUS:
            result = bsdfdata.filterRadius.xxx;
            break;
        case DEBUGVIEW_STACKLIT_BSDFDATA_CURVATURE:
