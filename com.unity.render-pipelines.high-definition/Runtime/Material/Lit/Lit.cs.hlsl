...
#define DEBUGVIEW_LIT_SURFACEDATA_CURVATURE (1012)
...
#define DEBUGVIEW_LIT_BSDFDATA_SHAPE_PARAM (1061)
#define DEBUGVIEW_LIT_BSDFDATA_WORLD_SCALE (1062)
#define DEBUGVIEW_LIT_BSDFDATA_FILTER_RADIUS (1063)
#define DEBUGVIEW_LIT_BSDFDATA_CURVATURE (1064)
#define DEBUGVIEW_LIT_BSDFDATA_THICKNESS (1065)
#define DEBUGVIEW_LIT_BSDFDATA_USE_THICK_OBJECT_MODE (1066)
#define DEBUGVIEW_LIT_BSDFDATA_TRANSMITTANCE (1067)
#define DEBUGVIEW_LIT_BSDFDATA_TANGENT_WS (1068)
#define DEBUGVIEW_LIT_BSDFDATA_BITANGENT_WS (1069)
#define DEBUGVIEW_LIT_BSDFDATA_ROUGHNESS_T (1070)
#define DEBUGVIEW_LIT_BSDFDATA_ROUGHNESS_B (1071)
#define DEBUGVIEW_LIT_BSDFDATA_ANISOTROPY (1072)
#define DEBUGVIEW_LIT_BSDFDATA_IRIDESCENCE_THICKNESS (1073)
#define DEBUGVIEW_LIT_BSDFDATA_IRIDESCENCE_MASK (1074)
#define DEBUGVIEW_LIT_BSDFDATA_COAT_ROUGHNESS (1075)
#define DEBUGVIEW_LIT_BSDFDATA_GEOMETRIC_NORMAL (1076)
#define DEBUGVIEW_LIT_BSDFDATA_GEOMETRIC_NORMAL_VIEW_SPACE (1077)
#define DEBUGVIEW_LIT_BSDFDATA_IOR (1078)
#define DEBUGVIEW_LIT_BSDFDATA_ABSORPTION_COEFFICIENT (1079)
#define DEBUGVIEW_LIT_BSDFDATA_TRANSMITTANCE_MASK (1080)
...
void GetGeneratedSurfaceDataDebug(uint paramId, SurfaceData surfacedata, inout float3 result, inout bool needLinearToSRGB)
{
    switch (paramId)
    {
        ...
        case DEBUGVIEW_LIT_SURFACEDATA_SUBSURFACE_MASK:
            ...
            break;
        case DEBUGVIEW_LIT_SURFACEDATA_CURVATURE:
...
void GetGeneratedBSDFDataDebug(uint paramId, BSDFData bsdfdata, inout float3 result, inout bool needLinearToSRGB)
{
    switch (paramId)
    {
        ...
        case DEBUGVIEW_LIT_BSDFDATA_SUBSURFACE_MASK:
            ...
            break;
        case DEBUGVIEW_LIT_BSDFDATA_SHAPE_PARAM:
            result = bsdfdata.shapeParam;
            break;
        case DEBUGVIEW_LIT_BSDFDATA_WORLD_SCALE:
            result = bsdfdata.worldScale.xxx;
            break;
        case DEBUGVIEW_LIT_BSDFDATA_FILTER_RADIUS:
            result = bsdfdata.filterRadius.xxx;
            break;
        case DEBUGVIEW_LIT_BSDFDATA_CURVATURE:
